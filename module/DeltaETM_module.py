...
class scCLR_module_mask_decoder_no_softmax(BaseModuleClass):
    ...
    def __init__(
        ...
        self.lbeta1= nn.Parameter(torch.randn(latent_dims,self.total_genes))
		self.lbeta2= nn.Parameter(torch.randn(latent_dims,self.total_genes))
        self.w_g = nn.Parameter(torch.randn(self.total_genes))
